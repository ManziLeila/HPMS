...
const translations = {
    EN: {
        ...
        deleteClientChoose: 'What should happen to the employees under this client?',
        deleteClientKeepEmployees: 'Keep employees',
        deleteClientKeepDesc: 'Employees stay in the database and will be unassigned (no client).',
        deleteClientDeleteEmployees: 'Delete all employees',
        deleteClientDeleteDesc: 'Employees and their salary records will be permanently deleted.',
    ...
    FR: {
        ...
        deleteClientChoose: 'Que doit-il arriver aux employés de ce client ?',
        deleteClientKeepEmployees: 'Conserver les employés',
        deleteClientKeepDesc: 'Les employés restent dans la base de données et seront désassignés (sans client).',
        deleteClientDeleteEmployees: 'Supprimer tous les employés',
        deleteClientDeleteDesc: 'Les employés et leurs fiches de paie seront définitivement supprimés.',
